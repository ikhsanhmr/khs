...
require 'PHPMailer/PHPMailerAutoload.php';
	...
	function mail_attachment($subject,$receiver_mail,$receiver_name,$body,$addreplyto,$addcc,$addReceiver) {
		...
		$mail->Username = 'akun_login';                 // SMTP username
		//$mail->Password = 'P@ss-2018';                           // SMTP password
		$mail->Password = 'passwordnya';                           // SMTP password
		$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
		$mail->Port = 25;                                    // TCP port to connect to

		$mail->setFrom('emailnya@pln.co.id', 'Admin KHS');
		...
		$mail->addBCC('pakaigmailaja@ya.com', 'admin IT');
		...
		//ada penambahan code ini, khusus kasus SMTP connect() failed. https://github.com/PHPMailer/PHPMailer/wiki/Troubleshooting di server 10.29.1.44
