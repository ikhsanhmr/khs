...
$area       = select_nama_area($kode_area);
$nama_area  = $area[0][0];
...
function format_indo($date)
{
    ...
    else
    {
        ...
        $getdata_query = mysqli_query("select * from tb_spj where spj_no = '$no_spj'");
        while($data_spj=mysqli_fetch_array($getdata_query))
        { $spj_data[] = $data_spj; }

        $dir_vendor     = get_direksi($spj_data[0][1]);
        $vendor         = $spj_data[0][1];
        $skkio          = $spj_data[0][2];
        ...
        $no_pjn     = get_no_pjn($vendor, $paket_kerja);
        $tgl_pjn_f  = date('Y-m-d',strtotime(get_tgl_pjn($vendor, $paket_kerja)));
        $tgl_pjn    = format_indo($tgl_pjn_f);
        ...
        $v = select_nama_vendor($vendor);
        $nama_vendor = $v[0][0];

        $p = select_desk_paket($paket_kerja);
        $paket_deskripsi = $p[0][0];

        $ss = "select skki_tanggal from tb_skko_i WHERE skki_no = '$skkio'";
        //echo $ss;
        $skki_search = mysqli_query($ss);
...
<style type="text/css">
    ...
    #printarea { padding:10px 0;width:800px; margin: auto; font:Times New Roman;    font-size:12;}
    ...
    .tablesorter thead tr { height: 30px; background: #E6E6E6; text-align: left; text-indent: 10px; cursor: pointer; }
}
...
<body class="page" id="printarea">
    ...
    <tr>
            <td height="113" colspan="5"><p>&nbsp;</p></td>
      </tr>
        <tr>
            <td>Nomor</td>
            <td>:</td>
    ...
    <table width="901" style="border-collapse: collapse; border: 1px solid black;">
        ...
        <tr class="p-border">
            ...
            <td width="299" colspan="-22"><div align="center"><strong>Jenis Pekerjaan</strong></div></td>
            <td width="85"><div align="center"><strong>Sat</strong></div></td>
            <td width="85"><div align="center"><strong>Vol</strong></div></td>
            <td width="170"><div align="center"><strong>Harga Satuan</strong></div></td>
            <td width="170"><div align="center"><strong>Jumlah</strong></div></td>
        </tr>
        <tr>
            ...
            <td><div align="center">1</div></td>
            <td><div align="center"><?php echo number_format($spj);?></div></td>
            <td><div align="center"><?php echo number_format($jumlah);?></div></td>
        </tr>
        <tr>
            <td colspan="4" rowspan="3">&nbsp;</td>
            <td><strong>Jumlah</strong></td>
            <td><div align="center"><?echo number_format($jumlah);?></div></td>
        </tr>
        <tr>
            <td><strong>Ppn 10%</strong></td>
            <td><div align="center"><?echo number_format($ppn);?></div></td>
        </tr>
        <tr>
            <td><strong>Jumlah + PPN 10%</strong></td>
            <td><div align="center"><?echo number_format($total);?></div></td>
        </tr>
        <tr>
            <td colspan="4">&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr>
            <td colspan="6"><font size="3"><strong><i>Terbilang : <?php echo terbilang(str_replace(",","",$total)); ?></i> </strong></font></td>
        </tr>
    </table>
    ...
    <tr>
            ...
            <ol>
                <li>
                    <div align="justify">Waktu penyerahan pekerjaan (BASTP) harus dilakukan paling lambat <?php //echo $HITUNG_HARI;?> 50 (Lima Puluh) hari kalender sejak ditandatanganinya Surat Pesanan Jasa atau sampai dengan <?php echo $tgl_sampai;?></div>
                </li>
                <!--
                <li>
                    <div align="justify">
        ...
        <tr>
            ...
            <td width="441"><div align="center"><b>Setuju Melaksanakan,</b></div></td>
          
      </tr>
        <tr>

            <td width="441"><div align="center"><strong><?php echo $nama_vendor;?></strong></div></td>
          <td width="451"><div align="center"><strong>MANAJER</strong></div></td>
      </tr>
        <tr>
          <td><div align="center"><strong>Direktur Utama</strong></div></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
           <td><div align="center"><?php echo strtoupper($dir_vendor) ?></div></td> <!--nama dir vendor-->
          <td><div align="center"><?php echo $nama_manager;?></div></td> <!--nama manajer-->
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
