...
where SKKI.AREA_kode = SKKO.AREA_kode";
                            ...
                            for ($i=0;$i<count($data);$i++) {
								...
								<tr><td height="39"><div align="left"><?php echo $area ?></div></td>
                                ...
                                } elseif ($terkontrak_sski>=50) {
                                    $class="badge badge-info";
                                } elseif ($terkontrak_sski>=25) {
                                    ...
                                    $class="badge badge-success";
                                } elseif ($terkontrak_ssko>=50) {
                                    $class="badge badge-info";
                                } elseif ($terkontrak_ssko>=25) {
                                    $class="badge badge-warning";
                                } else {
                                    $class="badge badge-danger";
                                }; ?>
                                    ...
                                    $class="badge badge-success";
                                } elseif ($bayar_kontrak_i>=50) {
                                    $class="badge badge-info";
                                } elseif ($bayar_kontrak_i>=25) {
                                    $class="badge badge-warning";
                                } else {
                                    $class="badge badge-danger";
                                }; ?>
                                    ...
                                    $class="badge badge-success";
                                } elseif ($bayar_kontrak_o>=50) {
                                    $class="badge badge-info";
                                } elseif ($bayar_kontrak_o>=25) {
                                    $class="badge badge-warning";
                                } else {
                                    $class="badge badge-danger";
                                }; ?>
                                    ...
                                    $class="badge badge-success";
                                } elseif ($bayar_sski>=50) {
                                    $class="badge badge-info";
                                } elseif ($bayar_sski>=25) {
                                    $class="badge badge-warning";
                                } else {
                                    $class="badge badge-danger";
                                }; ?>
                                    ...
                                    $class="badge badge-success";
                                } elseif ($bayar_ssko>=50) {
                                    $class="badge badge-info";
                                } elseif ($bayar_ssko>=25) {
                                    $class="badge badge-warning";
                                } else {
                                    $class="badge badge-danger";
                                }; ?>
						...
						<tr><td height="39"><div align="left"><b>Total</b></div></td>
							...
							<?php $PERSEN_TKONTRAK_I = floor((($TKONTRAK_SKKI/$TSKKI)*100));
                                    if ($PERSEN_TKONTRAK_I>=75) {
                                        $class="badge badge-success";
                                    } elseif ($PERSEN_TKONTRAK_I>=50) {
                                        $class="badge badge-info";
                                    } elseif ($PERSEN_TKONTRAK_I>=25) {
                                        $class="badge badge-warning";
                                    } else {
                                        $class="badge badge-danger";
                                    }; ?>
							...
							<?php $PERSEN_TKONTRAK_O = floor((($TKONTRAK_SKKO/$TSKKO)*100));
                                    if ($PERSEN_TKONTRAK_O>=75) {
                                        $class="badge badge-success";
                                    } elseif ($PERSEN_TKONTRAK_O>=50) {
                                        $class="badge badge-info";
                                    } elseif ($PERSEN_TKONTRAK_O>=25) {
                                        $class="badge badge-warning";
                                    } else {
                                        $class="badge badge-danger";
                                    }; ?>
							...
							<?php $PERSEN_TBAYAR_I = floor((($TBAYAR_SKKI/$TKONTRAK_SKKI)*100));
                                    if ($PERSEN_TBAYAR_I>=75) {
                                        $class="badge badge-success";
                                    } elseif ($PERSEN_TBAYAR_I>=50) {
                                        $class="badge badge-info";
                                    } elseif ($PERSEN_TBAYAR_I>=25) {
                                        $class="badge badge-warning";
                                    } else {
                                        $class="badge badge-danger";
                                    }; ?>
							...
							<?php $PERSEN_TBAYAR_O = floor((($TBAYAR_SKKO/$TKONTRAK_SKKO)*100));
                                    if ($PERSEN_TBAYAR_O>=75) {
                                        $class="badge badge-success";
                                    } elseif ($PERSEN_TBAYAR_O>=50) {
                                        $class="badge badge-info";
                                    } elseif ($PERSEN_TBAYAR_O>=25) {
                                        $class="badge badge-warning";
                                    } else {
                                        $class="badge badge-danger";
                                    }; ?>
...
(select 
            ...
            for ($i=0;$i<count($data1);$i++) {
                ...
                $area = $data1[$i][4]; ?>
								<tr><td height="39"><div align="left"><?php echo $jenis ?></div></td>
                    ...
                    $class="badge badge-success";
                } elseif ($persen_bayar>=50) {
                    $class="badge badge-info";
                } elseif ($persen_bayar>=25) {
                    $class="badge badge-warning";
                } else {
                    $class="badge badge-danger";
                }; ?>
                    ...
                    $class="badge badge-success";
                } elseif ($persen_bayar_skki>=50) {
                    $class="badge badge-info";
                } elseif ($persen_bayar_skki>=25) {
                    $class="badge badge-warning";
                } else {
                    $class="badge badge-danger";
                }; ?>
