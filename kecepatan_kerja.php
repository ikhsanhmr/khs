    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php if ($print_session == 0 or $print_session == 1 or $print_session == 12 or $print_session == 14) { ?>
                            <section class="panel">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control m-b-10" name="area">
                                                ...
                                                for ($i = 0; $i < count($data_area); $i++) {
                                                    ...
                                                    $current_area_nama = $data_area[$i][1]; ?><option value="<?php echo $current_area_kode; ?>"><?php echo $current_area_nama; ?></option>
                                                    <?php
                                                } ?>
                                            </select>
                                        </div>
                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            ...
                            <div class="panel-body table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        if ($area == "" && $vendor == "") {
											...
											FROM tb_spj a left join tb_vendor b on a.VENDOR_ID = b.VENDOR_ID
                                                          ...
                                                          LEFT JOIN tb_skko_i e on a.SKKI_NO = e.SKKI_NO
                                                          LEFT JOIN tb_area f on e.AREA_KODE = f.AREA_KODE
                                            WHERE b.VENDOR_NAMA LIKE '%$vendor%' and a.area_kode=$area";
                                            $count_res = mysqli_query($mysqli, $count);
                                            $r = mysqli_fetch_row($count_res);
                                            $numrows = $r[0];
                                        ...
                                        for ($i = 0; $i < count($data); $i++) {
										  ...
										  <td><span class='$class'>$b%</span></td></td>
										  <td><span class='$class1'>$c%</span></td></tr>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
                                ...
                                ?>
                                <p class="text-center"><a href="kecepatan_kerja_excel.php?area=<?php echo $print_area; ?>&vendor=<?php echo $vendor; ?>" class='btn btn-success center'>Export Excel</a></p>
