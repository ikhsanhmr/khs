	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			<div class="panel-body table-responsive">
				...
				?>
				<section class="panel">
					<header class="panel-heading">Verifikasi Evaluasi Vendor Manager Bidang</header>
					<div class="panel-body table-responsive">
						...
						<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
							...
							<tbody>
								...
								$querys = "SELECT A.SPJ_NO, B.evaluasi, B.verifikasi_mb, B.catatan_verifikasi_mb, B.verifikasi_mup3, catatan_verifikasi_mup3 From 
								...
								for ($j = 0; $j < count($datas); $j++) {
									...
									if ($verifikasi_evaluasi_mb == 0) {
										$verifikasi_evaluasi_mb = "<a href='isi_verifikasi_mb.php?&no_spj=$spj_no'><span class='badge badge-info'>belum diverifikasi</span></a>";
									} else {
										$verifikasi_evaluasi_mb = "<a href='isi_verifikasi_mb.php?&no_spj=$spj_no'><span class='badge badge-success'>sudah diverifikasi</span>  $catatan_verifikasi_mb</a>";
									}
									...
									if ($verifikasi_evaluasi_mup3 == 0) {
										$verifikasi_evaluasi_mup3 = "<a href='#'><span class='badge badge-info'>belum diverifikasi</span></a>";
									} else {
										$verifikasi_evaluasi_mup3 = "<a href='#'><span class='badge badge-success'>sudah diverifikasi</span>  $catatan_verifikasi_mup3</a>";
									}
