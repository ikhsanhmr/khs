	...
	<body class="skin-black">
		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
								...
								<div class="panel-body table-responsive">
								<div class="demo-html"></div>
								<form class="form-horizontal" action="#" role="form" method="post" onsubmit="return confirm('Yakin menyimpan perubahan ini?');"/>             
									...
									<div class="form-group">
										<label class="col-sm-4"></label>
											<div class="col-sm-4">
												...
												?>
												<div class="col-sm-4">
												<a href="isi_verifikasi_mup3_submit.php?&no_spj=<?php echo $get_spj?>&verifikasi=1" onclick="return confirm('Anda Setuju Dengan  Evaluasi ini?')"  class="btn btn-success"><i class="glyphicon glyphicon-check"></i> Setuju</a>
												</div>
												<div class="col-sm-4">
												<a href="isi_verifikasi_mup3_catatan.php?&no_spj=<?php echo $get_spj?>&verifikasi=2" onclick="return confirm('Anda Menolak Evaluasi ini?')"  class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> Tolak</a>
												</div>
													<?php }else{
														echo $status;
													?>
