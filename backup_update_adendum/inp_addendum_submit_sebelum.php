...
if($res_insert_tb_add==1 && $res_update_fin_vendor==1 && $res_update_skki_terpakai==1 && $res_update_nilai_add==1 && $res_update_tanggal_akhir==1 && $res_update_pagu_terpakai ==1){
