		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<section class="content">
				...
				<div class="row">
					<div class="col-md-12">
						<section class="panel">
							<header class="panel-heading">Download ALL</header>
							<div class="panel-body">
								<form role="form" method="post" action="download_rekap_all.php">
										<div class="col-sm-2">
								...
								<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
									...
									<?php
                                        ...
                                        for ($j=0;$j<count($datas);$j++) {
                                            ...
                                            $no = $j+$offset+1;
                                            $download_rekap = "<a href='download_rekap.php?&vendor_id=$vendor_id'>
