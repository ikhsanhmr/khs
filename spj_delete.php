...
$resultQueryxx=mysqli_query($sqlxx);
...
if($data[0][0] =='0')
	{
		...
		*/
		...
		//echo $sql;
		$resultQuery1=mysqli_query($sql1);
		$resultQuery2=mysqli_query($sql2);
		$resultQuery3=mysqli_query($sql3);
		$resultQuery=mysqli_query($sql);
		$resultQuery4=mysqli_query($sql4);
		$resultQuery5=mysqli_query($sql5);
		$resultQuery6=mysqli_query($sql6);
		
	if($resultQuery1==1 and $resultQuery2==1 and $resultQuery3==1 and $resultQuery==1 and $resultQuery4==1
