    ...
    <!-- Main content -->
        <section class="content">
			<div class="row">
				<div class="col-md-12">
					<section class="panel">
					<header class="panel-heading">Upload SKKI</header>
					<div class="panel-body">
						<form class="form-horizontal tasi-form" method="post" enctype="multipart/form-data" action="upload_skki_submit.php" >
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="file" class="form-control" name="file_skki" id="file_skki">
								</div>
							</div>
