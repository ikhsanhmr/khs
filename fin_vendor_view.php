			...
			<aside class="right-side">
				...
				<section class="content">
					...
					<div class="row">
						<div class="col-md-12">
							<section class="panel">
								<header class="panel-heading">UPDATE FINANSIAL</header>
									...
									<table class="table table-hover">
										<thead>
											<tr align="center">
												...
												<td><strong>Rating Laporan Audit</strong></td>
												<td><strong>Finansial Limit</strong></td>
												<td><strong>Finansial Current</strong></td>
											</tr>
										</thead>
										<tbody>
											<?php
												...
												for($i=0;$i<count($data);$i++){
													...
													$delete_action = "<a href='fin_vendor_delete.php?vendor_id=$current_vendor_id' onclick='return confirm(\"Delete : ".$current_vendor_id." ?\")'>Delete</a>";
													$no = $i+$offset+1;
													echo "<tr align='center'>
														  <td>$no</td>
														  <td>$current_vendor_id</td>
														  <td>$current_rating_lap_audit</td>
														  <td>Rp.$current_fin_limit</td>
														  <td>Rp.$current_fin_current</td>
														  <td>$edit_action</td>
														  <td>$delete_action</td>";
												}
											?>
