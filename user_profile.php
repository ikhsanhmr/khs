								...
								<div class="panel-body">
									<form class="form-horizontal tasi-form" method="post" action="update_user_submit.php">
										...
										<label class="col-sm-2 col-sm-2 control-label">Area</label>
											<div class="col-sm-10">
											<?php
												$data= ($kode_area != 54560) ? select_area_by_code($kode_area) : select_area();
										...
										<label class="col-sm-2 col-sm-2 control-label">Password</label>
											<div class="col-sm-10">
												<input type="text" class="form-control" name="var_password" value="<?php echo get_password($_SESSION['username']) ?>">
											</div>
										</div>
										...
										<label class="col-sm-2 col-sm-2 control-label">Email</label>
											<div class="col-sm-10">
												<input type="text" class="form-control" name="var_email"  value="<?php echo get_email($_SESSION['username']) ?>">
											</div>
										</div>
