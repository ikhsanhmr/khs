...
if ($get_var_no_spj=="") {
    ...
    echo '<script language="javascript">window.location = "inp_addendum.php"</script>';
} elseif ($get_var_nilai_addendum==0 && $get_var_tanggal_akhir=="" && $get_var_skki_tujuan=="-") {
    ...
    echo '<script language="javascript">window.location = "inp_addendum.php"</script>';
} elseif ($get_var_nilai_addendum >$res2[0][0]) {
    echo '<script language="javascript">alert("nilai addendum melebihi nilai SKKI/O")</script>';
    echo '<script language="javascript">window.location = "inp_addendum.php"</script>';
} elseif ($get_var_tanggal_akhir != null and strtotime($get_var_tanggal_akhir) < strtotime($res3[0][0])) {
    ...
    } elseif ($get_var_tanggal_akhir!="" && $get_var_nilai_addendum==0) {
        //$res_insert_tb_add = mysqli_query($mysqli, $insert_tb_add);;
    ...
    if ($get_var_skki_tujuan != '-') {
        $GET_NILAI_ADD_DB = select_nilai_add($get_var_no_spj, $mysqli);
