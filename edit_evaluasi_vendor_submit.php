<?php
        ...
        if ($tgl_bastp<=$tgl_spbj) {
            ...
            $simp1 = mysqli_query($mysqli, "DELETE from penilaian_nilai where spj_no='$no_spj'");
            ...
            $simp3 = mysqli_query($mysqli, "UPDATE tb_termin set verifikasi_mb=0, verifikasi_mup3=0 where spj_no='$no_spj'");
